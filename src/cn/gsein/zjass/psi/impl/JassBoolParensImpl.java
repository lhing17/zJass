...
public class JassBoolParensImpl extends ASTWrapperPsiElement implements JassBoolParens {

  public JassBoolParensImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JassVisitor visitor) {
    visitor.visitBoolParens(this);
  }
