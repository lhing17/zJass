...
public class JassCodeLiteralImpl extends ASTWrapperPsiElement implements JassCodeLiteral {

  public JassCodeLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JassVisitor visitor) {
    visitor.visitCodeLiteral(this);
  }
  ...
  public JassFuncRef getFuncRef() {
    return findChildByClass(JassFuncRef.class);
  }
