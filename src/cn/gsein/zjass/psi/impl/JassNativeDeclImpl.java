...
public class JassNativeDeclImpl extends ASTWrapperPsiElement implements JassNativeDecl {
  ...
  @Override
  @NotNull
  public JassFuncParmList getFuncParmList() {
    return findNotNullChildByClass(JassFuncParmList.class);
  }

  @Override
  @NotNull
  public JassFuncReturnType getFuncReturnType() {
    return findNotNullChildByClass(JassFuncReturnType.class);
  }
