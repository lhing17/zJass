...
public class JassRealAtomImpl extends ASTWrapperPsiElement implements JassRealAtom {

  public JassRealAtomImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JassVisitor visitor) {
    visitor.visitRealAtom(this);
  }
  ...
  @Override
  @Nullable
  public JassRealParens getRealParens() {
    return findChildByClass(JassRealParens.class);
  }
