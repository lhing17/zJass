...
public class JassRuleReturnImpl extends ASTWrapperPsiElement implements JassRuleReturn {

  public JassRuleReturnImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JassVisitor visitor) {
    visitor.visitRuleReturn(this);
  }
